...
class Interfaz extends JFrame{
	...
	public Interfaz() {
	    	...
	    	JTextField txtfPrimero = new JTextField("Subscribe to our mailing list");
	    	txtfPrimero.setBounds(5, 120, 240, 30);
	    	add(txtfPrimero);
	    	
	    	JRadioButton radioPrimero = new JRadioButton("only required fields");
	    	radioPrimero.setBounds(5, 180, 240, 30);
	    	add(radioPrimero);
	    	
	    	JRadioButton radioSegundo = new JRadioButton("all fields");
	    	radioSegundo.setBounds(5, 210, 240, 30);
	    	add(radioSegundo);
	    	
	    	JLabel label5 = new JLabel("(edited fileds in the form builder)");
	    	label5.setBounds(70, 230, 240, 35);
	    	add(label5);
